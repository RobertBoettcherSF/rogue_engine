...
In-repo wiki mirrors **typed Ada packages** on `main`. If prose and code disagree, **code wins** — then update this page.

| Page | Topic |
|------|--------|
| [Premise](Premise.md) | Twofold bunker / rover setup |
| [Packages](Packages.md) | What each Ada unit owns |
