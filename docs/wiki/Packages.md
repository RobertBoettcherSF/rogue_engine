...
| `Game_Atmosphere` | yes | Tile air; O2-partial = PxO2%; cabin vs exterior | L2-L4 candidate |
| `Game_Turn` | yes | Turn / wall-minute clock; AP grant; walk cost | L2-L4 candidate |
| `Game_Ops_Room` | yes | 3x3 @ 1 m (9 m2), suit hook 2000 mm, dual doors | L2-L4 candidate |
