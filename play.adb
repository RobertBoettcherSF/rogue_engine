...
--  Layout: ASCII map | ≤4×80 message | strip P_kPa O2_kPa g_eff uSv_h
...
procedure Play is
   ...
   begin
      --  Clear screen + cursor home (fixed viewport; no scroll flood).
   ...
   begin
      ...
      Lines := 1;
      --  Payload wrapped into up to 3 more lines of 80
      declare
   ...
   procedure Put_Strip is
      ...
      G_Eff : Float;
   begin
      G_Eff := Float (Arc.G_Load_Tenths) / 10.0;
      ...
      TIO.Put ("  g_eff=");
      TIO.Put (G_Eff, Fore => 1, Aft => 2, Exp => 0);
      TIO.Put ("  uSv_h=");
      IIO.Put (Arc.Rad_uSv_h, Width => 0);
      TIO.Put ("  [");
