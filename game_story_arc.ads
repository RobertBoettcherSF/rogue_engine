...
package Game_Story_Arc is
   ...
   --  Live µSv/h (Physical_Data). Cabin 0 → Format_Rad "0.1". L2–L4 candidate.
   subtype Dose_Rate_uSv_h is Natural;
   Cabin_Rad_uSv_h    : constant Dose_Rate_uSv_h := 0;
   Ascent_SAA_uSv_h   : constant Dose_Rate_uSv_h := 30;
   Coast_GCR_uSv_h    : constant Dose_Rate_uSv_h := 75;
